...
public class ContractServiceImpl implements ContractService {
    ...
    public Report addContract(final Contract contract) {
        ...
        final Contract insertedContract = map(
            contractDao.insert(map(ImmutableContract.builder().from(contract).amcBasicAmount(amcBasicAmount).amcTax(tax)
                .amcTaxAmount(amcTaxAmount).amcTotalAmount(amcTotalAmount).customer(customerbyid)
    ...
    /** {@inheritDoc} */
    @Override
    public Contract getContractByProposalNo(final String proposalNo) {
        return null;
    }
    ...
    public SearchResponse<Contract> getContractsByEquipmentrId(final String equipmentId, final int page) {
        return ImmutableSearchResponse.<Contract> builder()
            .result(map(contractDao.findByEquipmentId(equipmentId, page)))
